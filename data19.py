...
def navee ():
    ...
    liststate = ["Assam", "Bihar", "Chandigarh", "Chhattisgarh", "Delhi", "Dadra and Nagar Haveli and Daman and Diu",
                 "Goa",
    ...
    Dadra_and_Nagar_Haveli_and_Daman_and_Diu_ss = df(
        r.json()["Dadra and Nagar Haveli and Daman and Diu"]["districtData"])
    ...
    for i in Dadra_and_Nagar_Haveli_and_Daman_and_Diu_s:
        if (
            ...
            Dadra_and_Nagar_Haveli_and_Daman_and_Diu_active.append(
                Dadra_and_Nagar_Haveli_and_Daman_and_Diu_ss[i]["active"])
